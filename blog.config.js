...
const BLOG = {
  ...
  AUTHOR: 'Jiege', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://www.jiege.fun', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: '191352277@qq.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/bingyang518', // 你的github个人主页
  CONTACT_TELEGRAM: 'https://t.me/bingyang518', // 你的telegram 地址 例如 https://t.me/tangly_1024
